...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      adapter: 'sails-mysql',
      url: `mysql://${adminDB.user}:${adminDB.password}@${adminDB.host}:${adminDB.port}/${adminDB.database}`,
      charset: 'utf8mb4'
    }
  },
  ...
  sockets: {
     ...
     *                                                                          *	
     ***************************************************************************/
    onlyAllowOrigins: ['https://api.hypr.pk', 'https://admin.hypr.pk'],
    /***************************************************************************	
     *                                                                          *	
